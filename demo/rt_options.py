...
class RTOptions():
    ...
    def __init__(self):
        ...
        # input options
        parser.add_argument('--input_path', type=str, default='webcam', help="""Path of video, image, or a folder where image files exists""")
        ...
        parser.add_argument('--save_bbox_output', action='store_false', default=False, help='Save the bboxes in json files (bbox_xywh format)')
        parser.add_argument('--save_pred_pkl', action='store_false', default=False, help='Save the predictions (bboxes, params, meshes in pkl format')
        parser.add_argument("--save_mesh", action='store_false', default=False, help="Save the predicted vertices and faces")
        parser.add_argument("--save_frame", action='store_false', default=False, help='Save the extracted frames from video input or webcam')

        # Other options
        parser.add_argument('--single_person', action='store_true', default=True, help='Reconstruct only one person in the scene with the biggest bbox')
        parser.add_argument('--no_display', action='store_true', default=True, help='Do not visualize output on the screen')
